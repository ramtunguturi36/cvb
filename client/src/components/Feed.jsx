					...
					<div className="bg-white rounded-2xl w-full max-w-md shadow-2xl border border-gray-200 overflow-hidden">
						<div className="bg-gradient-to-r from-green-500 to-teal-500 p-6 text-white">
							<div className="flex justify-between items-center">
								...
								<button
									onClick={() => setMessage('')}
									className="w-10 h-10 bg-red-100/50 rounded-full flex items-center justify-center hover:bg-red-200/70 hover:scale-110 transition-all duration-200 shadow-lg"
								>
